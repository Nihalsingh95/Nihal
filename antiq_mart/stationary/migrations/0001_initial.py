    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('INSRUMENTS', 'instruments'), ('FURNITURE', 'Furniture'), ('ART', 'art')], max_length=20)),
                ...
                ('antique_image', models.ImageField(upload_to='antique_images')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stationary.antique')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('antique', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stationary.antique')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stationary.customer')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
